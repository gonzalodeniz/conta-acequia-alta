...
- Si detecta deuda tecnica o una mejora tecnica necesaria fuera del alcance inmediato de la issue, debe dejarla documentada y enlazada en la validacion para que `product-manager` la registre como trabajo trazable en backlog o en una issue separada.
...
- `[qa-teams] Registra validacion funcional de la issue 12 en changelog`
