...
Este archivo define las reglas globales del repositorio `conta-acequia-alta` y aclara como deben activarse las instrucciones especificas de cada rol.
...
- `AGENTS.md`: reglas globales del repositorio y marco de colaboracion entre roles.
...
`conta-acequia-alta` es una aplicacion web para llevar la contabilidad de una comunidad de vecinos. La plataforma centraliza gastos comunes, ingresos, presupuestos y reportes financieros en un unico lugar para mejorar la transparencia, la comunicacion y la toma de decisiones informadas dentro de la comunidad.


### Problema que resuelve

La contabilidad de la comunidad se gestiona actualmente de forma manual, mediante hojas de calculo o procedimientos tradicionales propensos a errores, desactualizacion y dificultades para compartir la informacion. Esto genera confusion, retrasos en decisiones operativas y una menor transparencia financiera.


### Usuarios objetivo

- Administradores de fincas o responsables de la gestion economica de la comunidad.
- Vecinos que necesitan consultar el estado financiero de la comunidad y entender su evolucion.


### Capacidades clave esperadas

- Gestion de gastos e ingresos con registro y categorizacion de movimientos.
- Cierre del libro de cuentas anual con soporte para generar reportes financieros detallados.
- Visualizacion de asientos contables para seguimiento y analisis.
- Generacion de reportes financieros claros para facilitar la toma de decisiones.
- Acceso de solo lectura para vecinos con foco en transparencia.
- Importacion de datos desde hojas de calculo u otros sistemas previos.
- Notificaciones y recordatorios sobre fechas relevantes, pagos o reuniones.
...
- `product-manager` debe registrar tambien en backlog las auditorias o hallazgos relevantes reportados por `quality-auditor` y `security-auditor` cuando requieran seguimiento trazable.
