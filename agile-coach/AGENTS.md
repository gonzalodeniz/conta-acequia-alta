...
- Si una nueva entrada de `changelog/` sobre `main` invalida un ejemplo o un estado citado en un artefacto vivo, debe actualizar ese artefacto o marcarlo como historico antes de reutilizarlo como referencia vigente.
- Mientras esa actualizacion no exista, el artefacto no debe seguir tratandose como `vigente` aunque la cabecera previa siga sin cambiarse.
